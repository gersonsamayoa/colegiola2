...
<div class="">
	<a href="{{route('admin.cursos.index')}}" class="btn btn-primary pull-right">Regresar al Listado de Curso</a>
</div>
      ...
      <th>Acción</th>
		...
		@foreach($cursosalumnosasignados as $cursoalumnoasignado)
				...
				@if($cursoalumnoasignado->curso_id==$cursos->id)
					...
					<td><div class="form-group">
								{!!Form::text('promedio',$cursoalumnoasignado->promedio,['class'=>'form-control','placeholder'=> '', ''])!!}
					</div></td>
